    ...
    >
      <div className="relative z-0 mt-56 flex w-full items-center justify-center">
        <motion.div
          ...
          className="bg-gradient-conic dark:from-cyan absolute inset-auto right-1/2 h-56 w-[30rem] overflow-visible from-blue-200 via-transparent to-transparent [--conic-position:from_70deg_at_center_top] dark:via-transparent"
        >
        ...
        <motion.div
          ...
          className="bg-gradient-conic dark:to-cyan absolute inset-auto left-1/2 h-56 w-[30rem] from-transparent via-transparent to-blue-200 [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="dark:bg-cyan absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-blue-200 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
