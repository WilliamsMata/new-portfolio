...
export function SkillContentTab({ title, skillsData }: Skill) {
  return (
    <SkillContentTabContainer title={title}>
      <div className="from-blue to-cyan absolute inset-0 h-full w-full scale-[0.80] transform rounded-full bg-red-500 bg-gradient-to-r blur-3xl" />

      <div className="border-gray-t00 relative flex h-full flex-col items-start overflow-y-auto rounded-2xl border bg-blue-100 shadow-xl dark:bg-background">
